...
## 5. Motivation: conductive material is a limited resource
...
## 8. Thirty packings with the same nominal porosity
...
## 9. Contact conductance links temperature difference to heat rate
...
## 10. Thermal conductance follows contact size and material
...
## 11. Allocation methods and teacher search
...
## 12. Every method uses the same conductive-material budget
...
## 17. All-low thermal solve before material allocation
...
## 18. Graph learning and prediction
...
## 19. The GNN uses geometry and the all-low thermal solution
...
## 20. The GNN performs particle classification
...
## 21. Soft classification targets come from the search
...
## 22. Ranking within size classes enforces the budget
...
## 23. Applying the trained GNN to a new packing
...
## 24. Each test packing is withheld from model fitting
...
## 26. Gain and recovery answer different questions
...
## 27. GNN improves conductivity by 30% over random
...
## 28. Absolute conductivity remains below the search reference
...
## 29. GNN beats MLP on 29 of 30 held-out packings
...
## 30. Contact-network diagnostics help interpret allocation
...
## 31. Numerical checks pass, but contact sizes need scrutiny
...
## 32. The numerical overlap floor has little influence
...
## 33. Fast scoring is one part of the complete prediction procedure
...
## 34. Conclusions and next research steps
